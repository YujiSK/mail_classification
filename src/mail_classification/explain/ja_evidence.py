"""Japanese counterpart of ``evidence.py``.

Identical decision-score/contribution logic; forked only because
``evidence.py`` imports the English condition functions at module level.
"""
