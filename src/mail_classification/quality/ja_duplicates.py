"""Japanese counterpart of ``duplicates.py``: swaps ``EnglishPreprocessor``
for ``JapanesePreprocessor`` for the "normalized" match type. Identical
otherwise; forked rather than parameterized so the English quality-gate path
stays untouched (``docs/audits/task10_ja_reuse_matrix.md``).
"""
