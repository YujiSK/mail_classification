"""Japanese counterpart of ``statistics.py``: swaps ``EnglishPreprocessor``
for ``JapanesePreprocessor`` so token-length statistics use Sudachi
tokenization instead of the English regex tokenizer. Identical otherwise.
"""
